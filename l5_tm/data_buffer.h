...
void data_buffer_write (data_buffer_struct *,uint8_t);
// Zapis bajtu do bufora
uint8_t data_buffer_read  ( data_buffer_struct * );
// Odczyt bajtu z bufora
uint8_t data_buffer_number( data_buffer_struct * );
// Iloœæ bajtów danych w buforze
